            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="empleadoDropdown">
                        <li><a class="dropdown-item" href="app/models/Empleado/mantenimiento_empleado.php">Mantenimiento</a></li>
                        <li><a class="dropdown-item" href="app/models/Empleado/insertar_empleado.php">Insertar Nuevo</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="llamadasDropdown">
                        <li><a class="dropdown-item" href="app/models/Llamadas/listado_llamadas.php">Listado</a></li>
                        <li><a class="dropdown-item" href="app/models/Llamadas/agregar_llamada.php">Agregar Nueva</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="puestosDropdown">
                        <li><a class="dropdown-item" href="app/models/Puesto/mantenimiento_puesto.php">Mantenimiento</a></li>
                        <li><a class="dropdown-item" href="app/models/Puesto/insertar_puesto.php">Insertar Nuevo</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="tiendasDropdown">
                        <li><a class="dropdown-item" href="app/models/Tiendas/listado_tiendas.php">Listado</a></li>
                        <li><a class="dropdown-item" href="app/models/Tiendas/agregar_tienda.php">Agregar Nueva</a></li>
                    </ul>
                </li>
            </ul>
        </div>
