            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="tiendasDropdown">
                        <li><a class="dropdown-item" href="app/models/Tiendas/tiendas.php">Listado</a></li>
                        <li><a class="dropdown-item" href="app/models/Tiendas/insertar_tienda.php">Agregar Nueva</a></li>
                    </ul>
                </li>
            </ul>
        </div>
