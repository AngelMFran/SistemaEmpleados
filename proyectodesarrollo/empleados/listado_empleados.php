...
class EmpleadoModel
{
    ...
    // Método para obtener los puestos para el combobox
    ...
    // Método para obtener las tiendas para el combobox
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="id_puesto" name="id_puesto" required>
                <?php foreach ($puestos as $puesto): ?>
                    <option value="<?= $puesto['id_puesto'] ?>" <?= $puesto['id_puesto'] == $empleado['id_puesto'] ? 'selected' : '' ?>>
                        <?= $puesto['puesto'] ?>
                    </option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="id_tienda" name="id_tienda" required>
                <?php foreach ($tiendas as $tienda): ?>
                    <option value="<?= $tienda['id_tienda'] ?>" <?= $tienda['id_tienda'] == $empleado['id_tienda'] ? 'selected' : '' ?>>
                        <?= $tienda['tienda'] ?>
                    </option>
                <?php endforeach; ?>
            </select>
